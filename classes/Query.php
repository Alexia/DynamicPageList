		...
		foreach ($option as $orderMethod) {
			switch ($orderMethod) {
				...
				case 'sortkey':
					...
					if (is_array($this->parameters->getParameter('category')) && is_array($this->parameters->getParameter('notcategory')) && count($this->parameters->getParameter('category')) + count($this->parameters->getParameter('notcategory')) > 0) {
